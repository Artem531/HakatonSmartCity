...
"conda env create -f env-gpu.yml" установить все необходимые библиотеки для работы алгоритма (Это может занять время))

Плюс дополнительно поставить следующие библиотеки:
1) pip install imutils
2) conda install dlib
3) conda install -c conda-forge scikit-image
